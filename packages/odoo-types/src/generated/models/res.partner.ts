// Auto-generated from res.partner (Odoo fields_get)
// DO NOT EDIT — run `bun run generate` in @odooseek/odoo-codegen to regenerate

import type { BaseRecord, ModelFieldName, ModelRecord } from '../core'

/** res.partner */
export interface ResPartnerRecord extends BaseRecord {
  /** SEO optimized */
...
You can use this field for quick search. */
  ...
  /** Barcode — Use a barcode to identify this contact. */
  ...
  /** Employees — Related employees based on their private address */
...
/** Field names for res.partner */
export type ResPartnerFieldName = ModelFieldName<ResPartnerRecord>

/** Typed search_read result */
export type ResPartnerSearchResult = ModelRecord<ResPartnerRecord>
