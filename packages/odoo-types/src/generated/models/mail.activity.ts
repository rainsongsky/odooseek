// Auto-generated from mail.activity (Odoo fields_get)
// DO NOT EDIT — run `bun run generate` in @odooseek/odoo-codegen to regenerate

import type { BaseRecord, ModelFieldName, ModelRecord } from '../core'

/** mail.activity */
export interface MailActivityRecord extends BaseRecord {
  /** Document Model */
  ...
  activity_category: 'default' | 'upload_file' | 'phonecall' | 'meeting' | false
  /** Decoration Type — Change the background color of the related activities of this type. */
  activity_decoration: 'warning' | 'danger' | false
  ...
  /** Automated activity — Indicates this activity has been created automatically and not by any user. */
  automated: boolean
  /** Attachments */
...
Anywhere else, time values are computed according to the time offset of your web client. */
  ...
  /** Calendar Meeting */
  calendar_event_id: [number, string] /* calendar.event */ | false
}

/** Field names for mail.activity */
export type MailActivityFieldName = ModelFieldName<MailActivityRecord>

/** Typed search_read result */
export type MailActivitySearchResult = ModelRecord<MailActivityRecord>
