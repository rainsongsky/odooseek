// Auto-generated from mrp.workcenter (Odoo fields_get)
// DO NOT EDIT — run `bun run generate` in @odooseek/odoo-codegen to regenerate

import type { BaseRecord, ModelFieldName, ModelRecord } from '../core'

/** mrp.workcenter */
export interface MrpWorkcenterRecord extends BaseRecord {
  /** Active — If the active field is set to False, it will allow you to hide the resource record without removing it. */
  active: boolean
  /** Alternative Workcenters — Alternative workcenters that can be substituted to this one in order to dispatch production */
  alternative_workcenter_ids: number[] /* mrp.workcenter */ | false
  /** Analytic Distribution */
  analytic_distribution: unknown | false
  /** Analytic Precision */
  analytic_precision: number | false
  /** Blocked Time — Blocked hours over the last month */
  blocked_time: number | false
  /** Product Capacities — Specific number of pieces that can be produced in parallel per product. */
  capacity_ids: number[] /* mrp.workcenter.capacity */
  /** Code */
  code: string | false
  /** Color */
  color: number | false
  ...
  /** Cost per hour — Hourly processing cost. */
  costs_hour: number | false
  /** Costs Hour Account */
  costs_hour_account_ids: number[] /* account.analytic.account */ | false
  /** Created on */
  ...
  /** Expense Account — The expense is accounted for when the manufacturing order is marked as done. If not set, it is the expense account of the final product that will be used instead. */
  expense_account_id: [number, string] /* account.account */ | false
  /** Has Message */
  has_message: boolean
  /** Has Routing Lines — Technical field for workcenter views */
  ...
  oee_target: number | false
  /** Orders */
  order_ids: number[] /* mrp.workorder */
  /** Performance — Performance over the last month */
  performance: number | false
  /** Productive Time — Productive hours over the last month */
  productive_time: number | false
  /** Ratings */
  rating_ids: number[] /* rating.rating */
  /** Working Hours — Define the working schedule of the resource. If not set, the resource will have fully flexible working hours. */
  resource_calendar_id: [number, string] /* resource.calendar */ | false
  /** Resource */
  resource_id: [number, string] /* resource.resource */
  /** Routing Lines */
  routing_line_ids: number[] /* mrp.routing.workcenter */
  /** Sequence — Gives the sequence order when displaying a list of work centers. */
  sequence: number
  /** Tag */
  tag_ids: number[] /* mrp.workcenter.tag */ | false
  /** Time Efficiency — This field is used to calculate the expected duration of a work order at this work center. For example, if a work order takes one hour and the efficiency factor is 100%, then the expected duration will be one hour. If the efficiency factor is 200%, however the expected duration will be 30 minutes. */
  time_efficiency: number | false
  /** Time Logs */
  time_ids: number[] /* mrp.workcenter.productivity */
  /** Setup Time */
  time_start: number | false
  /** Cleanup Time */
  time_stop: number | false
  ...
  /** Work Center Load */
  workcenter_load: number | false
  /** Workcenter Status */
  working_state: 'normal' | 'blocked' | 'done' | false
  /** Total Pending Orders */
  workorder_blocked_count: number | false
  /** # Work Orders */
  workorder_count: number | false
  /** Total Late Orders */
  workorder_late_count: number | false
  /** Total Running Orders */
  workorder_progress_count: number | false
  /** # To Do Work Orders */
  workorder_ready_count: number | false
  /** Last Updated on */
...
/** Field names for mrp.workcenter */
export type MrpWorkcenterFieldName = ModelFieldName<MrpWorkcenterRecord>

/** Typed search_read result */
export type MrpWorkcenterSearchResult = ModelRecord<MrpWorkcenterRecord>
